...
EXTERN_C const IID IID_IOPCSecurityNT;
    ...
    {
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE IsAvailableNT( 
            /* [out] */ BOOL *pbAvailable) = 0;
        
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE QueryMinImpersonationLevel( 
            /* [out] */ DWORD *pdwMinImpLevel) = 0;
        
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE ChangeUser( void) = 0;
    ...
    typedef struct IOPCSecurityNTVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE *IsAvailableNT )( 
            IOPCSecurityNT * This,
            /* [out] */ BOOL *pbAvailable);
        
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE *QueryMinImpersonationLevel )( 
            IOPCSecurityNT * This,
            /* [out] */ DWORD *pdwMinImpLevel);
        
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE *ChangeUser )( 
            IOPCSecurityNT * This);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityNT_IsAvailableNT_Proxy( 
    IOPCSecurityNT * This,
    /* [out] */ BOOL *pbAvailable);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityNT_QueryMinImpersonationLevel_Proxy( 
    IOPCSecurityNT * This,
    /* [out] */ DWORD *pdwMinImpLevel);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityNT_ChangeUser_Proxy( 
    IOPCSecurityNT * This);
...
EXTERN_C const IID IID_IOPCSecurityPrivate;
    ...
    {
    public:
        virtual /* [helpstring] */ HRESULT STDMETHODCALLTYPE IsAvailablePriv( 
            /* [out] */ BOOL *pbAvailable) = 0;
    ...
    typedef struct IOPCSecurityPrivateVtbl
    {
        ...
        /* [helpstring] */ HRESULT ( STDMETHODCALLTYPE *IsAvailablePriv )( 
            IOPCSecurityPrivate * This,
            /* [out] */ BOOL *pbAvailable);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityPrivate_IsAvailablePriv_Proxy( 
    IOPCSecurityPrivate * This,
    /* [out] */ BOOL *pbAvailable);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityPrivate_Logon_Proxy( 
    IOPCSecurityPrivate * This,
    /* [string][in] */ LPCWSTR szUserID,
    /* [string][in] */ LPCWSTR szPassword);
...
/* [helpstring] */ HRESULT STDMETHODCALLTYPE IOPCSecurityPrivate_Logoff_Proxy( 
    IOPCSecurityPrivate * This);
